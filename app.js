...
form.addEventListener("submit", function (e) {
  ...
  if (
    ...
    confirmPasswordError.textContent = "Password should be at last 8 characters. and Password Should be content at least one uppercase letter, one lowercase letter, and one digit.";
  }
